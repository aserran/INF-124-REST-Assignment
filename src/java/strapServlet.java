 ...
 * @author Tony
 */
public class strapServlet extends HttpServlet {
    static final String JDBC_DRIVER = "com.mysql.jdbc.Driver";
    static final String DB_URL = "jdbc:mysql://localhost/coolfitteddb";//sylvester-mccoy-v3.ics.uci.edu/inf124-db-002";
    static final String USER = "root";//inf124-db-002";
            ...
            throws ServletException, IOException 
    {
        ...
        try{
            ...
            query = "SELECT images.imagepath, images.imagename, details.title, details.price FROM images INNER JOIN details ON images.imagename=details.imagename AND images.imagename LIKE '%strap1%'";
