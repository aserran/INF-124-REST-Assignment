...
public class indexServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try{
            ...
            query = "SELECT images.imagepath, images.imagename, details.title, details.price FROM images INNER JOIN details ON images.imagename=details.imagename AND images.idimages > 47";
