...
public class snapServlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try{
            ...
            query = "SELECT images.imagepath, images.imagename, details.title, details.price FROM images INNER JOIN details ON images.imagename=details.imagename AND images.imagename LIKE '%snap1%'";
